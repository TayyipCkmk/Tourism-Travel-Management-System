...
<header class="header p-3 ">
    ...
    border-radius: 30px;">
            ...
            <a href="/user/logout" class="p-3 btn btn-dark me-2"style="border-radius: 30px;margin-inline-start: 760px">Log Out</a>
...
<section class="home-content ">
    <div class="content">
        ...
        <div class="container pt-5 d-flex flex-column justify-content-center align-items-center">
            <h2 class="text-white mb-3"style="color:#f7c86f;">Update Tour</h2>

            <form value="${item.fromLocation}" action="/update" method="post"
                ...
                <input value="${item.price}" required class="form-control mt-2" placeholder="Price" type="number"
                       name="price"/>

                <button type="submit" class="btn btn-success mt-2"style="border-radius: 30px;width: 40%;margin-inline-start: 155px;">Save</button>
                <%
